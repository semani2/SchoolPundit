<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="FrontEnd2.UserLogin" %>
...
<body onkeydown="body_onkeydown()">
    ...
    <table height="100%" width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <tr>
            <td width="100%"  height="3" bgcolor="#8da01a"   style="color:white ;font-size:larger;"> <font face="Lucida Console"style="margin-left:40px" /> USER LOGIN</td>
            </tr>
            
            <tr>

            <td width="100%"  >
            <table  border="0" cellspacing="0" cellpadding="0" width="60%" bgcolor="#b72828" style="opacity:0.7;
  filter:alpha(opacity=60);height:36%">
            ...
            <p><font  face ="Calibri"  color="white" /><pre>                     Please Enter your email id/Mobile Number </pre> </p>
               <pre>          <asp:TextBox ID="TextBox3" runat="server"  Width="50%" Height="20px" >
               </asp:TextBox><font  face ="Calibri"  color="white" />
              </pre>
         ...
         <p><font  face ="Calibri"  color="white" /> <pre>                     Password</pre> </p>
           ...
           <asp:LinkButton ID="Loginlnk" runat="server" style="text-decoration: none;color:white;margin-left:75px"> <font size="2.5pt" face="Calibri" color="white"  />Forgot Password ?</asp:LinkButton>
             ...
             OnOkScript="ok()"
             CancelControlID="CancelBtn" />  <br />
                <asp:Label ID="Label1" runat="server"></asp:Label>
          <br />
               <p align="left"> <asp:Button ID="Button1" runat="server" Text="Sign up!" BorderStyle="None" 
                    style="background-color:#ca0000;margin-left:65px" ForeColor="White" 
                       onclick="Button1_Click" />
               
                
               <asp:Button ID="Button2" runat="server" Text="Login" BorderStyle="None" 
                    style="background-color:#ca0000;margin-left:200px" ForeColor="White" 
                       onclick="Button2_Click" />
         
       
          
                <asp:Button ID="Button3" runat="server" Text="Cancel" BorderStyle="None" 
                    style="background-color:#ca0000" ForeColor="White" onclick="Button3_Click" /></p>
