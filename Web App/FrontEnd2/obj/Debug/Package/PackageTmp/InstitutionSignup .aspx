...
<th colspan="4" align="left"> <font  color="#0066ff">Account Details</font> <hr  color="#7ca2d2" /></th>
...
<th colspan="4" align="left"> <font  color="#0066ff">Institute Details </font> <hr  color="#7ca2d2"/></th>
...
<tr style="height:40px"><td><div class="left">
        ...
        <td width="28%"><div class="right">
          <asp:DropDownList ID="DropDownList2" runat="server" Width="150px" style="float:left">
            </asp:DropDownList>
            </div>
         </td>
<td width="18%"><div class="left">
...
<tr style="height:40px"><td><div class"left">
        ...
        <td width="28%"><div class="right">
          <asp:DropDownList ID="DropDownList1" runat="server" Width="150px" style="float:left">
            </asp:DropDownList>
            </div></td>
