...
<!-- MAIN DATA START -->
            ...
            <table height="45%" border="0" cellspacing="0" cellpadding="0" width="70%" bgcolor="#d8d8d8" style="opacity:0.5; ">
                                          ...
                                          <th colspan="4" align="left"> <font  color="#0066ff">Profile Settings</font> <hr  color="#7ca2d2" /> </th>
                                                <tr><td colspan="4" align="right"> <asp:Button ID="Button2" runat="server"
Text="Edit" style="text-decoration:underline" BorderStyle="None" Width="50px" Font-Size="Medium" ForeColor="#000099"></asp:Button>  </td></tr>
...
<td colspan="4" style="vertical-align:center"  align="right">
    ...
    <asp:Button ID="Button1" runat="server" Text="Update" BackColor="#ed830e" 
        ForeColor="White" BorderStyle="None"  style="margin-right:50px" /> </td>
           ...
           <!-- END OF DATA -->
            ...
            <table height="45%" border="0" cellspacing="0" cellpadding="0" width="70%" bgcolor="#d8d8d8" style="opacity:0.5; ">
                                          ...
                                          <th colspan="4" align="left"> <font  color="#0066ff">Account Settings</font> <hr  color="#7ca2d2" /></th>
                                                  <tr><td align="right" colspan="4"> <asp:Button ID="Button4" runat="server" Text="Edit" BorderStyle="None" Font-Underline="True" Width="50px" ForeColor="#3366CC" Font-Size="Medium"></asp:Button> </td></tr>
                                                <tr style="height:40px">
                                                   <td width="17%" align="left">
