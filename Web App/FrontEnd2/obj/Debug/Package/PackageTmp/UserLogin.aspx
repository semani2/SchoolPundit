...
<body>
  ...
  filter:alpha(opacity=60);height:36%">
         ...
         <p><font  face ="Calibri"  color="white" /> <pre>                     Password</pre> </p>
           ...
           <asp:LinkButton ID="LinkButton2" runat="server" style="text-decoration: none;color:white;margin-left:75px"> <font size="2.5pt" face="Calibri" color="white"  />Forgot Password ?</asp:LinkButton>
                <br />
